...
public class AiRequestInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    public AiRequestInterceptor(TabNoteInfiniteEncryption tabNoteInfiniteEncryption, VipMapper vipMapper, AiService aiService, SecurityComponent securityComponent) {
