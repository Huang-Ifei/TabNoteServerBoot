...
public interface MessageServiceInterface {
    JSONObject getTabNoteMessage(String tab_note_id,Integer start,String usr_id);

    JSONObject insertTabNoteMessage(String id, String token,String ip_address,String tab_note_id,String message);

    JSONObject getMessageMessage(String reply_message_id, Integer start,String usr_id);
